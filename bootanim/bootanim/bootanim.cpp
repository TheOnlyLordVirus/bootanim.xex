// bootanim.cpp : Defines the entry point for the application.
//
...
//-------------------------------------------------------------------------------------
// Name: bootanim_0001()
// Desc: The application's entry point on system bootup.
//-------------------------------------------------------------------------------------
__declspec(dllexport) int bootanim_0001(int a1) 
{
	Sleep(60000);
...
// might not be needed.
__declspec(dllexport) int bootanim_0002() {
	return 0;
}
